...
from .fast_rcnn import FastRCNNOutputLayersSG, FastRCNNOutputLayerswithCOCO, FastRCNNOutputLayersSGMaskTransfer
from .scenegraph_head import build_scenegraph_head
from .fast_rcnn import fast_rcnn_inference

@ROI_HEADS_REGISTRY.register()
class StandardSGROIHeads(StandardROIHeads):
    @configurable
    def __init__(self,*, box_in_features, box_pooler, box_head, box_predictor, 
                    ...
                    train_on_pred_boxes=False, use_gt_box=True, use_gt_object_label=True, add_gt=True, freeze_layers=[], **kwargs):
...
@ROI_HEADS_REGISTRY.register()
class SGROIHeadsMaskTransfer(StandardROIHeads):
    @configurable
    def __init__(self,*, box_in_features, box_pooler, box_head, box_predictor, 
                    mask_in_features=None, mask_pooler=None, mask_head=None, 
                    keypoint_in_features=None, keypoint_pooler=None, keypoint_head=None,
...
@ROI_HEADS_REGISTRY.register()
class StandardMaskLabelROIHead(StandardROIHeads):
    @configurable
...
@ROI_HEADS_REGISTRY.register()
class StandardROIHeadsWithCOCO(StandardROIHeads):
    @classmethod
    def _init_box_head(cls, cfg, input_shape):
        # fmt: off
        in_features       = cfg.MODEL.ROI_HEADS.IN_FEATURES
